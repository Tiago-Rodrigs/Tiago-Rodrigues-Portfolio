...
import avatar_okay from '../../assets/avatar-okay.jpg';
import './style.css';
    ...
    render() {
        return (
            <div className="packages-container">
                ...
                <div className="packages-options">
                    ...
                    <div className="package" id="basic">
                        ...
                        <article className="container-package">
                            ...
                            <ul className="container-package-options">
                                <li><i class="fa fa-check green"></i>1 Page</li>
                                <li><i class="fa fa-check green"></i>Include Source Code</li>
                                <li><i class="fa fa-check green"></i>Responsive Design</li>
                                <li><i class="fa fa-check gray"></i>Logo</li>
                                <li><i class="fa fa-check gray"></i>Design Customization</li>
                    ...
                    <div className="package" id="standard">
                        ...
                        <article className="container-package">
                            ...
                            <ul className="container-package-options">
                                <li><i class="fa fa-check green"></i>3 Pages</li>
                                <li><i class="fa fa-check green"></i>Include Source Code</li>
                                <li><i class="fa fa-check green"></i>Responsive Design</li>
                                <li><i class="fa fa-check gray"></i>Logo</li>
                                <li><i class="fa fa-check gray"></i>Design Customization</li>
                    ...
                    <div className="package" id="premium">
                        ...
                        <article className="container-package">
                            ...
                            <ul className="container-package-options">
                                <li><i class="fa fa-check green"></i>5 Pages</li>
                                <li><i class="fa fa-check green"></i>Include Source Code</li>
                                <li><i class="fa fa-check green"></i>Responsive Design</li>
                                <li><i class="fa fa-check green"></i>Logo</li>
                                <li><i class="fa fa-check green"></i>Design Customization</li>
                            </ul>
                ...
                <img src={avatar_okay} className="avatar-okay" />
